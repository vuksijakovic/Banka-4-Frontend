...
const OnboardingPage: React.FC = () => {
    ...
    useEffect(() => {
        async function fetch2FASetup() {
            try {
                ...
                const response = await client.get<TwoFASetupResponse>('/verify/regenerate-authenticator');
    ...
    const handleCopy = () => {
        if (qrData?.tokenSecret) {
            navigator.clipboard.writeText(qrData.tokenSecret)
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                ...
                <p className="text-center text-gray-600 mb-4">
                    Or manually enter this secret: <span className="font-semibold">{qrData.tokenSecret}</span>
                </p>
                ...
                <div className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-center">Verify your authenticator</h2>
