...
// ✅ Privilegije specifične za klijente
const CLIENT_PRIVILEGES = ['FILTER', 'SEARCH', 'TRADE_STOCKS', 'VIEW_STOCKS'] as const;
...
const formSchema = z.object({
    ...
    privilege: z.union([
        z.tuple([]),
        z.array(z.enum(CLIENT_PRIVILEGES)),
    ]),
    linkedAccounts: z.array(z.string()).optional().default([]),
    active: z.boolean().default(true), // ✅ Dodato kao u EmployeeForm
});
        ...
        <Form {...form}>
            ...
            >
                ...
                <div className="flex items-center col-span-2 justify-between w-full">
                    ...
                    <Button disabled={isPending} type="submit" className="px-3 py-1 text-sm">
