...
export default function ClientProfile() {
  ...
  if (me.state !== 'logged-in' || me.type !== 'client') {
    return <p className="text-center text-gray-500">No client profile found.</p>;
  }
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input value={client.firstName} disabled className="bg-gray-100 dark:bg-gray-800 dark:text-white" />
              </div>

              {/* Last Name */}
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Last Name</Label>
                <Input value={client.lastName} disabled className="bg-gray-100 dark:bg-gray-800 dark:text-white" />
              </div>
              ...
              <div>
                ...
                <Input value={client.email} disabled className="bg-gray-100 dark:bg-gray-800 dark:text-white" />
              </div>

              {/* Phone Number */}
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Phone Number</Label>
                <Input value={client.phone} disabled className="bg-gray-100 dark:bg-gray-800 dark:text-white" />
              </div>

              {/* Address */}
              <div>
                <Label className="text-gray-700 dark:text-gray-300">Address</Label>
                <Input value={client.address} disabled className="bg-gray-100 dark:bg-gray-800 dark:text-white" />
              </div>

              {/* Gender */}
              <div className="col-span-2">
                <Label className="text-gray-700 dark:text-gray-300">Gender</Label>
                <Input value={client.gender} disabled className="bg-gray-100 dark:bg-gray-800 dark:text-white" />
              </div>
            </div>
          </CardContent>
        </Card>
