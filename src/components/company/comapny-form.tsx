...
const activityCodes = [
    ...
    { code: '24.2', branch: 'Proizvodnja čeličnih cevi, šupljih profila i fitinga' },
    ...
    { code: '42.22', branch: 'Izgradnja elektroenergetskih i telekomunikacionih mreža' },
    ...
    { code: '47.11', branch: 'Trgovina u nespecijalizovanim prodavnicama sa hranom i pićem' },
    ...
    { code: '68.1', branch: 'Upravljanje nekretninama na osnovu naknade ili ugovora' },
    { code: '68.2', branch: 'Izdavanje i upravljanje nekretninama u sopstvenom ili iznajmljenom vlasništvu' },
...
export default function CompanyForm({ onSubmitAction, isPending = true }: CompanyFormProps) {
    const form = useForm({
            ...
            >
                ...
                <FormField control={form.control} name="tin" render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input type="text" placeholder="Tax Identification Number"  {...field} />
                        </FormControl>
                        <FormMessage className="text-red-500" />
                    </FormItem>
                )} />
                ...
                <FormField control={form.control} name="crn" render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input type="text" placeholder="Company Registration Number" {...field} />
                        </FormControl>
                        <FormMessage className="text-red-500" />
                    </FormItem>
                )} />
                ...
                <div className="flex justify-end">
                    <Button type="submit" variant="default" className="font-normal" disabled={!isPending}>
                        Add Company
                    </Button>
                </div>
            </form>
